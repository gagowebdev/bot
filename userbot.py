...
openai.api_key = "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"
...
async def answer(_, message):
    ...
    message_log = user_message.replace("\n", "")[:40] + '..' if user_message is not None else str()
    response = openai.Completion.create(
    model="text-davinci-003",
    prompt="Представь что ты живой человек и напиши краткий комментарии к этому посту: " + user_message,
    temperature=0.9,
    max_tokens=2048,
    top_p=1,
